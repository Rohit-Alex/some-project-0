...
export default function DeviceControl() {
  ...
  const detailSections: DetailSection[] = detailPanel?.data
    ? [
      ...
      { title: 'File Attributes', data: detailPanel.data.fileAttributes as unknown as Record<string, string> },
      { title: 'User Details', data: detailPanel.data.userDetails as unknown as Record<string, string> },
      { title: 'DLP Details', data: detailPanel.data.dlpDetails as unknown as Record<string, string> },
    ]
    : []
